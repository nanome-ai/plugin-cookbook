...
class RedisProcessNetwork(_ProcessNetwork):
    # Swap out requests to NTS and send to Redis instead
...
class PluginInstanceRedisInterface(PluginInstance):
    ...
    def configure_redis(self, redis_host, redis_port, redis_password, redis_channel):
        self._network = RedisProcessNetwork(redis_host, redis_port, redis_password, redis_channel=None)
